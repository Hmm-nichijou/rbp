		...
		var e = function() {
			...
			function r(e) {
				...
				if (e && t.test(e)) {
					if (4 === e.length) {
						for (var n = "#",
						r = 1; 4 > r; r += 1) n += e.slice(r, r + 1).concat(e.slice(r, r + 1));
						e = n
					}
			...
			window.WindowDblClick = function(e) {
				h = e,
				d.cbDoubleClickWnd && d.cbDoubleClickWnd(f, h)
			},
			...
			O = function(e, t) {
				...
				return y.I_SendHTTPRequest(t, s, r),
				n
			},
			J = function(e, n, r) {
				y.I_GetSecurityVersion(e, {
					success: function(e) {
						oSecurityCap.iKeyIterateNum = parseInt(t.$XML(e).find("keyIterateNum").eq(0).text(), 10),
			...
			K = function() {
				...
				n = 0; t > n; n++) navigator.mimeTypes[n].type.toLowerCase() == d.szMimeTypes && (e = "<embed align='center' type='" + d.szMimeTypes + "' width='" + a + "' height='" + u + "' name='" + l + "' wndtype='" + d.iWndowType + "' playmode='" + d.iPlayMode + "' colors='" + d.szColorProperty + "'>");
				return e
			},
			Y = function() {
				if (!ct() && null !== p) {
			...
			Q = function(e) {
				...
				y.I_GetAudioInfo(e.szIP, {
					success: function(n) {
						...
						e.m_iAudioBitRate = "" !== t.$XML(n).find("audioBitRate").eq(0).text() ? 1e3 * parseInt(t.$XML(n).find("audioBitRate").eq(0).text(), 10) : 0,
						e.m_iAudioSamplingRate = "" !== t.$XML(n).find("audioSamplingRate").eq(0).text() ? 1e3 * parseInt(t.$XML(n).find("audioSamplingRate").eq(0).text(), 10) : 0
					}
				})
			},
			et = function(e) {
				...
				e.oProtocolInc.getSystemCapa(e, {
					success: function(n) {
						...
						r.length > 0 && (e.bSupportWebsocket = "true" === t.$XML(n).find("NetworkCap").eq(0).find("isSupportWebsocket").eq(0).text()),
						e.bSupportWebsocket = !0,
						r = t.$XML(n).find("RacmCap").eq(0).find("isSupportMainAndSubRecord", !0),
						r.length > 0 && (e.bSupportSubStreamPlayback = "true" === t.$XML(n).find("RacmCap").eq(0).find("isSupportMainAndSubRecord").eq(0).text()),
			...
			tt = function() {
				...
				p.HWP_SetCanFullScreen(e),
				p.HWP_SetPackageType(d.iPackageType)
			},
			nt = function(e) {
				var t = -1,
				n = -1,
				...
				r = s.iDevicePort;
					...
					for (var o = ot(e), i = !1, a = 0; a < o.length; a++) if (o[a].ipv4 == e.szIP || o[a].ipv6 == e.szIP) {
						i = !0;
						break
					}
					i ? s = rt(e) : (s = st(e), -1 == s.iRtspPort && -1 == s.iDevicePort && (s = rt(e))),
					t = s.iRtspPort,
					n = s.iHttpPort,
					r = s.iDevicePort
				}
			...
			rt = function(e) {
				...
				return e.oProtocolInc.getPortInfo(e, {
					...
					success: function(e) {
						...
						n = 554;
						for (var i = 0,
						a = o.length; a > i; i++)"rtsp" === t.$XML(o).eq(i).find("protocol").eq(0).text().toLowerCase() && (n = parseInt(t.$XML(o).eq(i).find("portNo").eq(0).text(), 10)),
						"http" === t.$XML(o).eq(i).find("protocol").eq(0).text().toLowerCase() && (r = parseInt(t.$XML(o).eq(i).find("portNo").eq(0).text(), 10)),
						"dev_manage" === t.$XML(o).eq(i).find("protocol").eq(0).text().toLowerCase() && (s = parseInt(t.$XML(o).eq(i).find("portNo").eq(0).text(), 10))
					},
					error: function() {
						n = -1,
						r = -1,
			...
			st = function(e) {
				...
				return e.oProtocolInc.getUPnPPortStatus(e, {
					async: !1,
					success: function(e) {
						for (var o = t.$XML(e).find("portStatus", !0), i = 0, a = o.length; a > i; i++)"rtsp" == t.$XML(o).eq(i).find("internalPort").eq(0).text().toLowerCase() && (n = parseInt(t.$XML(o).eq(i).find("externalPort").eq(0).text(), 10)),
						"http" == t.$XML(o).eq(i).find("internalPort").eq(0).text().toLowerCase() && (r = parseInt(t.$XML(o).eq(i).find("externalPort").eq(0).text(), 10)),
						"admin" == t.$XML(o).eq(i).find("internalPort").eq(0).text().toLowerCase() && (s = parseInt(t.$XML(o).eq(i).find("externalPort").eq(0).text(), 10))
					},
					error: function() {
						n = -1,
						r = -1,
			...
			at = function(e) {
				e.oProtocolInc instanceof It && e.oProtocolInc.getSDKCapa(e, {
					...
					success: function(n) {
						...
						e.oStreamCapa.bSupportShttpPlay = "true" === t.$XML(n).find("isSupportHttpPlay").eq(0).text(),
						e.oStreamCapa.bSupportShttpPlayback = "true" === t.$XML(n).find("isSupportHttpPlayback").eq(0).text(),
						e.oStreamCapa.bSupportShttpsPlay = "true" === t.$XML(n).find("isSupportHttpsPlay").eq(0).text(),
						e.oStreamCapa.bSupportShttpsPlayback = "true" === t.$XML(n).find("isSupportHttpsPlayback").eq(0).text(),
						e.oStreamCapa.bSupportShttpPlaybackTransCode = "true" === t.$XML(n).find("isSupportHttpTransCodePlayback").eq(0).text(),
						e.oStreamCapa.bSupportShttpsPlaybackTransCode = "true" === t.$XML(n).find("isSupportHttpsTransCodePlayback").eq(0).text(),
						e.oStreamCapa.iIpChanBase = t.$XML(n).find("ipChanBase", !0).length > 0 ? parseInt(t.$XML(n).find("ipChanBase").eq(0).text(), 10) : 1
					},
					error: function() {
						e.oStreamCapa.bObtained = !0
					}
			...
			lt = function(e) {
				...
				n = location.port || "80";
				return d.proxyAddress && (t = d.proxyAddress.ip, n = d.proxyAddress.port),
				/^(http|https):\/\/([^\/]+)(.+)$/.test(e) && (e = e.replace(RegExp.$2, t + ":" + n)),
				S.cookie("webVideoCtrlProxy", RegExp.$2, {
					raw: !0
				}),
				e
			},
			dt = function(e) {
				var t = location.hostname,
				n = location.port || "80";
				return /^(ws):\/\/([^\/:]+):(\d+)\/(.+)$/.test(e) && (e = e.replace(RegExp.$2 + ":" + RegExp.$3, t + ":" + n)),
				e.indexOf("ws") > -1 ? S.cookie("webVideoCtrlProxyWs", RegExp.$2 + ":" + RegExp.$3, {
					raw: !0
			...
			this.I_InitPlugin = function(e, t, n) {
				if (a = e, u = t, S.extend(d, n), ct()) {
					var r = S.getDirName();
					r && ("object" == typeof exports && "undefined" != typeof module || ("function" == typeof define && define.amd ? require([r + "/jsPlugin-1.2.0.min.js"],
					function(e) {
						window.JSPlugin = e.JSPlugin,
						n.cbInitPluginComplete && n.cbInitPluginComplete()
					}) : S.loadScript(r + "/jsPlugin-1.2.0.min.js",
					function() {
						n.cbInitPluginComplete && n.cbInitPluginComplete()
					}))),
					...
					U(document.fullScreen) ? U(document.webkitIsFullScreen) ? U(document.mozFullScreen) || document.addEventListener("mozfullscreenchange",
					function() {
			...
			this.I_InsertOBJECTPlugin = function(e) {
				...
				if (ct()) {
					...
					if ("" != n) {
						for (var r = {},
						s = n.split(";"), o = "", i = 0, f = s.length; f > i; i++) o = s[i],
						o.indexOf("sub-background") > -1 ? r.background = "#" + o.split(":")[1] : o.indexOf("sub-border-select") > -1 ? r.borderSelect = "#" + o.split(":")[1] : o.indexOf("sub-border") > -1 && (r.border = "#" + o.split(":")[1]);
						t.oStyle = r
					}
					p = new JSPlugin(t)
				} else document.getElementById(d.szContainerID).innerHTML = K(),
				p = S.browser().msie ? document.getElementById(c) : document.getElementsByName(l)[0];
			...
			this.I2_OpenFileDlg = function(e) {
				...
				return ct() ? p.JS_OpenFileBrowser(e, "").then(function(t) {
					null != t ? 1 == e ? t.length > 100 && n.resolve( - 1) : t.length > 130 && n.resolve( - 1) : n.resolve(),
					n.resolve(t)
				}) : (t = p.HWP_OpenFileBrowser(e, ""), null != t ? 1 == e ? t.length > 100 && n.resolve( - 1) : t.length > 130 && n.resolve( - 1) : n.resolve(), n.resolve(t)),
				n
			},
			this.I_GetLocalCfg = function() {
				...
				r = [];
				return g = S.loadXML(n),
				r.push("<LocalConfigInfo>"),
				r.push("<ProtocolType>" + t.$XML(g).find("ProtocolType").eq(0).text() + "</ProtocolType>"),
				r.push("<PackgeSize>" + t.$XML(g).find("PackgeSize").eq(0).text() + "</PackgeSize>"),
				r.push("<PlayWndType>" + t.$XML(g).find("PlayWndType").eq(0).text() + "</PlayWndType>"),
				r.push("<BuffNumberType>" + t.$XML(g).find("BuffNumberType").eq(0).text() + "</BuffNumberType>"),
				r.push("<RecordPath>" + t.$XML(g).find("RecordPath").eq(0).text() + "</RecordPath>"),
				r.push("<CapturePath>" + t.$XML(g).find("CapturePath").eq(0).text() + "</CapturePath>"),
				r.push("<PlaybackFilePath>" + t.$XML(g).find("PlaybackFilePath").eq(0).text() + "</PlaybackFilePath>"),
				r.push("<PlaybackPicPath>" + t.$XML(g).find("PlaybackPicPath").eq(0).text() + "</PlaybackPicPath>"),
				r.push("<DeviceCapturePath>" + t.$XML(g).find("DeviceCapturePath").eq(0).text() + "</DeviceCapturePath>"),
				r.push("<DownloadPath>" + t.$XML(g).find("DownloadPath").eq(0).text() + "</DownloadPath>"),
				r.push("<IVSMode>" + t.$XML(g).find("IVSMode").eq(0).text() + "</IVSMode>"),
				r.push("<CaptureFileFormat>" + t.$XML(g).find("CaptureFileFormat").eq(0).text() + "</CaptureFileFormat>"),
				r.push("</LocalConfigInfo>"),
				e = S.loadXML(r.join(""))
			},
			this.I_SetLocalCfg = function(e) {
				...
				var n = S.loadXML(e),
				r = !1;
				return t.$XML(g).find("ProtocolType").eq(0).text(t.$XML(n).find("ProtocolType").eq(0).text()),
				t.$XML(g).find("PackgeSize").eq(0).text(t.$XML(n).find("PackgeSize").eq(0).text()),
				t.$XML(g).find("PlayWndType").eq(0).text(t.$XML(n).find("PlayWndType").eq(0).text()),
				t.$XML(g).find("BuffNumberType").eq(0).text(t.$XML(n).find("BuffNumberType").eq(0).text()),
				t.$XML(g).find("RecordPath").eq(0).text(t.$XML(n).find("RecordPath").eq(0).text()),
				t.$XML(g).find("CapturePath").eq(0).text(t.$XML(n).find("CapturePath").eq(0).text()),
				t.$XML(g).find("PlaybackFilePath").eq(0).text(t.$XML(n).find("PlaybackFilePath").eq(0).text()),
				t.$XML(g).find("DeviceCapturePath").eq(0).text(t.$XML(n).find("DeviceCapturePath").eq(0).text()),
				t.$XML(g).find("PlaybackPicPath").eq(0).text(t.$XML(n).find("PlaybackPicPath").eq(0).text()),
				t.$XML(g).find("DownloadPath").eq(0).text(t.$XML(n).find("DownloadPath").eq(0).text()),
				t.$XML(g).find("IVSMode").eq(0).text(t.$XML(n).find("IVSMode").eq(0).text()),
				t.$XML(g).find("CaptureFileFormat").eq(0).text(t.$XML(n).find("CaptureFileFormat").eq(0).text()),
			...
			this.getAuthType = function(e, n, r, s, o, i) {
				...
				u = {
					async: !0,
					success: function(r) {
						e.oAuthType[n] = t.$XML(r).find("sessionIDVersion").eq(0).text(),
						i()
					},
					error: function(t) {
						t > 500 && (e.oAuthType[n] = t),
						i(t)
					}
				};
			...
			this.setDeviceInfo = function(e, t, n, r, o) {
				var t = new s;
				return t.szIP = n,
				2 == r ? (t.szHttpProtocol = "https://", t.iHttpsPort = o) : (t.szHttpProtocol = "http://", t.iHttpPort = o),
				t.iCGIPort = o,
			...
			this.successV1cb = function(e, n, r, s, o, i, a, u) {
				...
				c.sesstionTimer = setInterval(function() {
					e.sessionHeartbeat(c,
					function() {
						c.sessionFailed = 0
					},
					function() {
						c.sessionFailed++,
						c.sessionFailed >= 5 && (window.PluginEventHandler(null, _, c.szDeviceIdentify), clearInterval(c.sesstionTimer))
					})
				},
				3e4)
			},
			this.successV2cb = function(e, t, n, r, s, o, i, a) {
				...
				u.sesstionTimer = setInterval(function() {
					...
					function() {
						u.sessionFailed++,
						u.sessionFailed >= 5 && (window.PluginEventHandler(null, _, u.szDeviceIdentify), clearInterval(u.sesstionTimer))
					})
				},
				3e4)
			},
			...
			this.I_Login = function(e, t, n, r, o, i) {
				...
				if ( - 1 != u) return N("设备已经登录过"),
				-1;
				var c = v,
				l = x;
				if (U(i.cgi) || (x == i.cgi ? (c = v, l = x) : (c = C, l = D)), ct()) if (x == l) {
					var d = new s;
					this.getAuthType(d, e, t, n, r,
					function() {
						var s = d.oAuthType[e];
					...
					if (x == l) {
						...
						S.extend(f, {
							error: function(s, a) {
								...
								S.extend(u, {
									error: function() {
										if (!U(i.cgi)) return i.error && i.error(s, a),
										void 0;
										p = S.Base64.encode(":" + r + ":" + o),
										l = D,
										c = C;
			...
			this.I_StartRealPlay = function(e, n) {
				...
				if (S.extend(l, n), -1 != r) {
					...
					var d = P[r];
					if (ct()) {
						if (!d.bSupportWebsocket) return n.error && n.error(403, pt()),
						void 0;
						...
						i = d.iWSPort,
						u = l.iStreamType,
						a = l.iChannelID <= d.iAnalogChannelNum ? l.iChannelID: d.oStreamCapa.iIpChanBase + parseInt(l.iChannelID, 10) - d.iAnalogChannelNum - 1,
						c = !0
					} else {
			...
			this.I_Stop = function(e) {
				...
				if ( - 1 != n) {
					...
					function() {
						...
						0 == s ? (I.splice(n, 1), t.success && t.success()) : t.error && t.error()
					}
			...
			this.I_SetVolume = function(e, t) {
				...
				return - 1 != r && (ct() ? (p.JS_SetVolume(t, e), n = 0) : n = p.HWP_SetVolume(t, e)),
				n
			},
			this.I2_CapturePic = function(e, t) {
				...
				if ( - 1 != r) if (ct()) {
					var i = "JPEG";
					".jpg" === e.slice( - 4).toLowerCase() ? e = e.slice(0, -4) : ".jpeg" === e.slice( - 5).toLowerCase() ? e = e.slice(0, -5) : ".bmp" === e.slice( - 4).toLowerCase() && (e = e.slice(0, -4), i = "BMP"),
					p.JS_CapturePicture(n.iWndIndex, e, i).then(function() {
						o.resolve()
					},
					function() {
						o.reject()
			...
			this.I_StopVoiceTalk = function() {
				...
				if (!ct()) {
					...
					for (var t = 0,
					n = P.length; n > t; t++) if (P[t].bVoiceTalk) {
						P[t].bVoiceTalk = !1;
						break
					}
				}
			...
			this.I_Enable3DZoom = function(e) {
				...
				if ( - 1 != t) {
					var r = I[t];
					r.b3DZoom || (ct() ? (n = 0, p.JS_Enable3DZoom(e,
					function(e) {
			...
			this.I_StartPlayback = function(e, n) {
				...
				if (S.extend(l, n), -1 != r) {
					...
					if (ct()) {
						if (!d.bSupportWebsocket) return n.error && n.error(403, pt()),
						void 0;
						if (!U(l.oTransCodeParam)) return n.error && n.error(),
						void 0;
					...
					r = this.findWndIndexByIndex(l.iWndIndex),
					-1 == r && (ct() ? (l.szStartTime = l.szStartTime.replace(" ", "T") + "Z", l.szEndTime = l.szEndTime.replace(" ", "T") + "Z", d.oProtocolInc.startPlayback(d, l).then(function() {
						n.success && n.success()
					},
					function() {
						n.error && n.error()
			...
			this.I_ReversePlayback = function(e, n) {
				...
				if (S.extend(d, n), -1 != r) {
					...
					-1 == r && (d.szStartTime = d.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z", d.szEndTime = d.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z", s = p.oProtocolInc.reversePlayback(p, d))
				}
				return - 1 == s && (p.iRtspPort = -1),
				s
			},
			this.I_Frame = function(e) {
				...
				if ( - 1 != n) {
					var r = I[n],
					s = r.iPlayStatus;
					if (s == A || s == L) if (ct()) p.JS_FrameForward(t.iWndIndex).then(function() {
						r.iPlayStatus = L,
						t.success && t.success()
					},
					function() {
			...
			this.I2_SetSnapPolygonInfo = function(r, s) {
				if (ct()) {
					...
					for (nodeList = t.$XML(o).find("SnapPolygon", !0), i = 0, iLen = nodeList.length; iLen > i; i++) {
						...
						u = n(u, 6),
						u = "#" + u;
						for (var c = [], l = t.$XML(node).find("point", !0), d = 0, f = l.length; f > d; d++) oNodePoint = l[d],
						c.push([500 * t.$XML(oNodePoint).find("x").eq(0).text(), 300 * t.$XML(oNodePoint).find("y").eq(0).text()]);
						a.push({
							iPolygonType: 1,
			...
			this.I_SetSnapPolygonInfo = function(r, s) {
				...
				var b = D.length,
				c = [];
				for (d = 0, f = D.length; f > d; d++) h = D[d],
				c.push(t.$XML(h).find("id").eq(0).text());
				var l = c.join(",");
			...
			this.findDeviceIndexByIP = function(e) {
				if (e.indexOf("_") > -1) {
					for (var t = 0,
					n = P.length; n > t; t++) if (P[t].szDeviceIdentify == e) return t
				} else for (var t = 0,
				n = P.length; n > t; t++) if (P[t].szIP == e) return t;
				return - 1
			},
			this.findWndIndexByIndex = function(e) {
				for (var t = 0,
				n = I.length; n > t; t++) if (I[t].iIndex == e) return t;
				return - 1
			};
			var ht = function() {
				this.iIndex = 0,
			...
			It.prototype.getDeviceInfo = function(e, n) {
				...
				S.extend(o, {
					success: function(e) {
						var r = [];
						r.push("<DeviceInfo>"),
						r.push("<deviceName>" + S.escape(t.$XML(e).find("deviceName").eq(0).text()) + "</deviceName>"),
						r.push("<deviceID>" + t.$XML(e).find("deviceID").eq(0).text() + "</deviceID>"),
						r.push("<deviceType>" + t.$XML(e).find("deviceType").eq(0).text() + "</deviceType>"),
						r.push("<model>" + t.$XML(e).find("model").eq(0).text() + "</model>"),
						r.push("<serialNumber>" + t.$XML(e).find("serialNumber").eq(0).text() + "</serialNumber>"),
						r.push("<macAddress>" + t.$XML(e).find("macAddress").eq(0).text() + "</macAddress>"),
						r.push("<firmwareVersion>" + t.$XML(e).find("firmwareVersion").eq(0).text() + "</firmwareVersion>"),
						r.push("<firmwareReleasedDate>" + t.$XML(e).find("firmwareReleasedDate").eq(0).text() + "</firmwareReleasedDate>"),
						r.push("<encoderVersion>" + t.$XML(e).find("encoderVersion").eq(0).text() + "</encoderVersion>"),
						r.push("<encoderReleasedDate>" + t.$XML(e).find("encoderReleasedDate").eq(0).text() + "</encoderReleasedDate>"),
						r.push("</DeviceInfo>"),
						e = S.loadXML(r.join("")),
						n.success && n.success(e)
					},
				...
				S.extend(o, {
					success: function(r) {
						...
						a = o.length; a > i; i++) {
							...
							s.push("<id>" + t.$XML(u).find("id").eq(0).text() + "</id>"),
							s.push("<inputPort>" + t.$XML(u).find("inputPort").eq(0).text() + "</inputPort>"),
							s.push("<name>" + S.escape(t.$XML(u).find("name").eq(0).text()) + "</name>"),
							s.push("<videoFormat>" + t.$XML(u).find("videoFormat").eq(0).text() + "</videoFormat>"),
							s.push("</VideoInputChannel>")
						}
						s.push("</VideoInputChannelList>"),
						r = S.loadXML(s.join("")),
				...
				S.extend(o, {
					success: function(e) {
						...
						for (var s = t.$XML(e).find("InputProxyChannel", !0), o = 0, i = s.length; i > o; o++) {
							...
							r.push("<id>" + t.$XML(a).find("id").eq(0).text() + "</id>"),
							r.push("<name>" + S.escape(t.$XML(a).find("name").eq(0).text()) + "</name>"),
							r.push("</InputProxyChannel>")
						}
						r.push("</InputProxyChannelList>"),
						e = S.loadXML(r.join("")),
					...
					S.extend(a, {
						success: function(e) {
							...
							for (var o = t.$XML(e).find("InputProxyChannelStatus", !0), i = 0, a = o.length; a > i; i++) {
								...
								r.push("<proxyProtocol>" + t.$XML(u).find("proxyProtocol").eq(0).text() + "</proxyProtocol>"),
								r.push("<addressingFormatType>" + t.$XML(u).find("addressingFormatType").eq(0).text() + "</addressingFormatType>"),
								r.push("<ipAddress>" + t.$XML(u).find("ipAddress").eq(0).text() + "</ipAddress>"),
								r.push("<managePortNo>" + t.$XML(u).find("managePortNo").eq(0).text() + "</managePortNo>"),
								r.push("<srcInputPort>" + t.$XML(u).find("srcInputPort").eq(0).text() + "</srcInputPort>"),
								r.push("<userName>" + S.escape(t.$XML(u).find("userName").eq(0).text()) + "</userName>"),
								r.push("<streamType>" + t.$XML(u).find("streamType").eq(0).text() + "</streamType>"),
								r.push("<online>" + t.$XML(u).find("online").eq(0).text() + "</online>"),
			...
			It.prototype.startRealPlay = function(e, t) {
				...
				if (ct()) {
					...
					r = dt(r),
					p.JS_Play(r, c, t.iWndIndex).then(function() {
						a(),
						u.resolve()
					},
					function() {
				...
				} else s = p.HWP_Play(r, e.szAuth, t.iWndIndex, "", ""),
				...
				S.extend(c, {
					...
					error: function(t, s) {
						if (k == e.szDeviceType || Z == e.szDeviceType) {
							o = n.bShttpIPChannel ? F(l.CGI.ptzControl.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : F(l.CGI.ptzControl.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID),
			...
			It.prototype.recordSearch = function(e, n) {
				...
				r = F(this.CGI.recordSearch, e.szHttpProtocol, e.szIP, e.iCGIPort),
				s = "<?xml version='1.0' encoding='UTF-8'?><CMSearchDescription><searchID>" + new o + "</searchID>" + "<trackList><trackID>" + (100 * i + a) + "</trackID></trackList>" + "<timeSpanList>" + "<timeSpan>" + "<startTime>" + u + "</startTime>" + "<endTime>" + c + "</endTime>" + "</timeSpan>" + "</timeSpanList>" + "<maxResults>40</maxResults>" + "<searchResultPostion>" + n.iSearchPos + "</searchResultPostion>" + "<metadataList>" + "<metadataDescriptor>//metadata.ISAPI.org/VideoMotion</metadataDescriptor>" + "</metadataList>" + "</CMSearchDescription>";
				var l = new Pt,
				d = {
					type: "POST",
					url: r,
				...
				S.extend(d, {
					success: function(e) {
						...
						r.push("<responseStatus>" + t.$XML(e).find("responseStatus").eq(0).text() + "</responseStatus>"),
						r.push("<responseStatusStrg>" + t.$XML(e).find("responseStatusStrg").eq(0).text() + "</responseStatusStrg>"),
						r.push("<numOfMatches>" + t.$XML(e).find("numOfMatches").eq(0).text() + "</numOfMatches>"),
						r.push("<matchList>");
						for (var s = t.$XML(e).find("searchMatchItem", !0), o = 0, i = s.length; i > o; o++) {
							var a = s[o];
							r.push("<searchMatchItem>"),
							r.push("<trackID>" + t.$XML(a).find("trackID").eq(0).text() + "</trackID>"),
							r.push("<startTime>" + t.$XML(a).find("startTime").eq(0).text() + "</startTime>"),
							r.push("<endTime>" + t.$XML(a).find("endTime").eq(0).text() + "</endTime>"),
							r.push("<playbackURI>" + S.escape(t.$XML(a).find("playbackURI").eq(0).text()) + "</playbackURI>"),
							r.push("<metadataDescriptor>" + t.$XML(a).find("metadataDescriptor").eq(0).text().split("/")[1] + "</metadataDescriptor>"),
							r.push("</searchMatchItem>")
						}
						r.push("</matchList>"),
						r.push("</CMSearchResult>"),
			...
			It.prototype.startPlayback = function(e, t) {
				...
				o = t.szEndTime,
				i = e.szIP;
				if ("rtsp://" === t.urlProtocol && (i = V(i)), ct()) if (d.proxyAddress) {
			...
			It.prototype.startDownloadRecord = function(e, t) {
				...
				return ct() ? (r = lt(r), n = p.JS_StartDownload(r, e.szAuth, t.szFileName, s)) : n = p.HWP_StartDownload(r, e.szAuth, t.szFileName, s, t.bDateDir),
				n
			},
			It.prototype.exportDeviceConfig = function(e, t) {
				...
				return t && (n = S.exportPasswordDeviceConfig(n, t)),
			...
			It.prototype.importDeviceConfig = function(e, t, n) {
				...
				return n && (r = S.exportPasswordDeviceConfig(r, n)),
			...
			It.prototype.asyncstartUpgrade = function(e, t) {
				...
				if (ct()) r = lt(r),
				s = lt(s),
				p.JS_StartUpgradeEx(r, s).then(function(e) {
					n.resolve(e)
				},
				function() {
					n.reject(o)
			...
			It.prototype.sessionV2Login = function(e, n, r, s, o, i, a, u) {
				...
				I = !1,
				m = "";
				t.$XML(a).find("isIrreversible", !0).length > 0 && (I = "true" === t.$XML(a).find("isIrreversible").eq(0).text(), m = t.$XML(a).find("salt").eq(0).text()),
				...
				C += "<isSessionIDValidLongTerm>" + d + "</isSessionIDValidLongTerm>",
			...
			mt.prototype.getDeviceInfo = function(e, n) {
				...
				S.extend(o, {
					success: function(e) {
						...
						r.push("<deviceName>" + S.escape(t.$XML(e).find("deviceName").eq(0).text()) + "</deviceName>"),
						r.push("<deviceID>" + t.$XML(e).find("deviceID").eq(0).text() + "</deviceID>"),
						r.push("<deviceType>" + t.$XML(e).find("deviceDescription").eq(0).text() + "</deviceType>"),
						r.push("<model>" + t.$XML(e).find("model").eq(0).text() + "</model>"),
						r.push("<serialNumber>" + t.$XML(e).find("serialNumber").eq(0).text() + "</serialNumber>"),
						r.push("<macAddress>" + t.$XML(e).find("macAddress").eq(0).text() + "</macAddress>"),
						r.push("<firmwareVersion>" + t.$XML(e).find("firmwareVersion").eq(0).text() + "</firmwareVersion>"),
						r.push("<firmwareReleasedDate>" + t.$XML(e).find("firmwareReleasedDate").eq(0).text() + "</firmwareReleasedDate>"),
						r.push("<encoderVersion>" + t.$XML(e).find("logicVersion").eq(0).text() + "</encoderVersion>"),
						r.push("<encoderReleasedDate>" + t.$XML(e).find("logicReleasedDate").eq(0).text() + "</encoderReleasedDate>"),
						r.push("</DeviceInfo>"),
						e = S.loadXML(r.join("")),
						n.success && n.success(e)
					},
				...
				S.extend(o, {
					success: function(e) {
						...
						for (var s = t.$XML(e).find("VideoInputChannel", !0), o = 0, i = s.length; i > o; o++) {
							...
							r.push("<id>" + t.$XML(a).find("id").eq(0).text() + "</id>"),
							r.push("<inputPort>" + t.$XML(a).find("inputPort").eq(0).text() + "</inputPort>"),
							r.push("<name>" + S.escape(t.$XML(a).find("name").eq(0).text()) + "</name>"),
							r.push("<videoFormat>" + t.$XML(a).find("videoFormat").eq(0).text() + "</videoFormat>"),
							r.push("</VideoInputChannel>")
						}
						r.push("</VideoInputChannelList>"),
						e = S.loadXML(r.join("")),
					...
					S.extend(a, {
						success: function(e) {
							...
							for (var o = t.$XML(e).find("DynVideoInputChannelStatus", !0), i = 0, a = o.length; a > i; i++) {
								...
								r.push("<id>" + c + "</id>"),
								r.push("<sourceInputPortDescriptor>"),
								r.push("<proxyProtocol>" + t.$XML(u).find("adminProtocol").eq(0).text() + "</proxyProtocol>"),
								r.push("<addressingFormatType>" + t.$XML(u).find("addressingFormatType").eq(0).text() + "</addressingFormatType>"),
								r.push("<ipAddress>" + t.$XML(u).find("ipAddress").eq(0).text() + "</ipAddress>"),
								r.push("<managePortNo>" + t.$XML(u).find("adminPortNo").eq(0).text() + "</managePortNo>"),
								r.push("<srcInputPort>" + t.$XML(u).find("srcInputPort").eq(0).text() + "</srcInputPort>"),
								r.push("<userName>" + S.escape(t.$XML(u).find("userName").eq(0).text()) + "</userName>"),
								r.push("<streamType>" + t.$XML(u).find("streamType").eq(0).text() + "</streamType>"),
								r.push("<online>" + t.$XML(u).find("online").eq(0).text() + "</online>"),
			...
			mt.prototype.getPortInfo = function(e, n) {
				...
				S.extend(o, {
					success: function(r) {
						...
						for (var o = t.$XML(r).find("AdminAccessProtocol", !0), i = 0, a = o.length; a > i; i++) o[i],
						s.push("<AdminAccessProtocol>"),
						s.push("<id>" + t.$XML(r).find("id").eq(0).text() + "</id>"),
						s.push("<enabled>" + t.$XML(r).find("enabled").eq(0).text() + "</enabled>"),
						s.push("<protocol>" + t.$XML(r).find("protocol").eq(0).text().toUpperCase() + "</protocol>"),
						s.push("<portNo>" + t.$XML(r).find("portNo").eq(0).text() + "</portNo>"),
						s.push("</AdminAccessProtocol>");
			...
			mt.prototype.startRealPlay = function(e, t) {
				...
				r = t.bZeroChannel ? F(t.cgi.zeroChannels, t.urlProtocol, s, t.iPort, n) : F(t.cgi.channels, t.urlProtocol, s, t.iPort, n);
			...
			mt.prototype.ptzAutoControl = function(e, t, n, r) {
				...
				o = "",
				i = "";
				if (r.iPTZSpeed = r.iPTZSpeed < 7 ? 15 * r.iPTZSpeed: 100, t && (r.iPTZSpeed = 0), e.szDeviceType != E) o = F(this.CGI.ptzAutoControl, e.szHttpProtocol, e.szIP, e.iCGIPort, s),
				i = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + r.iPTZSpeed + "</pan>" + "<tilt>0</tilt>" + "</PTZData>";
				else {
					var a = 99;
					t && (a = 96),
					o = F(this.CGI.goPreset, e.szHttpProtocol, e.szIP, e.iCGIPort, s, a)
				}
				var u = new Pt,
				c = {
					type: "PUT",
			...
			mt.prototype.setPreset = function(e, t, n) {
				var r = (t.iChannelID, ""),
				s = "";
				r = F(this.CGI.setPreset, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, n.iPresetID),
				s = "<?xml version='1.0' encoding='UTF-8'?>",
				s += "<PTZPreset>",
				s += "<id>" + n.iPresetID + "</id>",
				e.szDeviceType != E && (s += "<presetName>Preset" + n.iPresetID + "</presetName>"),
				s += "</PTZPreset>";
				var o = new Pt,
				i = {
					type: "PUT",
			...
			mt.prototype.deviceCapturePic = function(e, t, n, r) {
				...
				o = [];
				return S.isInt(r.iResolutionWidth) && o.push("videoResolutionWidth=" + r.iResolutionWidth),
				S.isInt(r.iResolutionHeight) && o.push("videoResolutionHeight=" + r.iResolutionHeight),
				o.length > 0 && (s += "?" + o.join("&")),
			...
			Ct.prototype.Base64 = {
				...
				encode: function(e) {
					var t, n, r, s, o, i, a, u = "",
					c = 0;
					for (e = Ct.prototype.Base64._utf8_encode(e); c < e.length;) t = e.charCodeAt(c++),
					n = e.charCodeAt(c++),
					r = e.charCodeAt(c++),
					s = t >> 2,
					o = (3 & t) << 4 | n >> 4,
				...
				decode: function(e) {
					var t, n, r, s, o, i, a, u = "",
					c = 0;
					for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); c < e.length;) s = this._keyStr.indexOf(e.charAt(c++)),
			...
			Ct.prototype.encodeAES = function(e, t, n, r) {
				var s = "";
				if ("ecb" === r) for (var o = e.length,
				i = 0; o > 0;) s += o > 16 ? aes_encrypt(e.substring(i, i + 16), t, !0) : aes_encrypt(e.substring(i), t, !0),
				o -= 16,
				i += 16;
				else {
			...
			Ct.prototype.sha256 = function(e) {
				...
				function(e) {
					for (var t = "",
					n = 0; n < 4 * e.length; n++) t += "0123456789abcdef".charAt(15 & e[n >> 2] >> 8 * (3 - n % 4) + 4) + "0123456789abcdef".charAt(15 & e[n >> 2] >> 8 * (3 - n % 4));
					return t
				} (function(e, r) {
					...
					for (e[r >> 5] |= 128 << 24 - r % 32, e[(r + 64 >> 9 << 4) + 15] = r, p = 0; p < e.length; p += 16) {
						for (s = m[0], o = m[1], i = m[2], a = m[3], u = m[4], c = m[5], l = m[6], d = m[7], f = 0; 64 > f; f++) v[f] = 16 > f ? e[f + p] : t(t(t(n(v[f - 2], 17) ^ n(v[f - 2], 19) ^ v[f - 2] >>> 10, v[f - 7]), n(v[f - 15], 7) ^ n(v[f - 15], 18) ^ v[f - 15] >>> 3), v[f - 16]),
						h = t(t(t(t(d, n(u, 6) ^ n(u, 11) ^ n(u, 25)), u & c ^ ~u & l), I[f]), v[f]),
						P = t(n(s, 2) ^ n(s, 13) ^ n(s, 22), s & o ^ s & i ^ o & i),
						d = l,
						l = c,
						c = u,
						u = t(a, h),
			...
			return c = "webVideoCtrl" + St,
			l = "webVideoCtrl" + St,
			"object" != typeof window.attachEvent && S.browser().msie && (S.createEventScript(c, "GetSelectWndInfo(SelectWndInfo)", "GetSelectWndInfo(SelectWndInfo);"), S.createEventScript(c, "ZoomInfoCallback(szZoomInfo)", "ZoomInfoCallback(szZoomInfo);"), S.createEventScript(c, "GetHttpInfo(lID, lpInfo, lReverse)", "GetHttpInfo(lID, lpInfo, lReverse);"), S.createEventScript(c, "PluginEventHandler(iEventType, iParam1, iParam2)", "PluginEventHandler(iEventType, iParam1, iParam2);"), S.createEventScript(c, "RemoteConfigInfo(lID)", "RemoteConfigInfo(lID);"), S.createEventScript(c, "KeyBoardEventInfo(iKeyCode)", "KeyBoardEventInfo(iKeyCode);")),
			this
		} (),
