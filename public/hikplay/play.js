...
// 登录
//clickLogin("192.168.1.160", 80, "admin", "qtrobot123");
//clickLogin("10.67.153.43", 14861, "admin", "qtrobot123");
function clickLogin(szIP, szPort, szUsername, szPassword, streamType, channels, iProtocol) {
    ...
    var iRet = WebVideoCtrl.I_Login(szIP, iProtocol, szPort, szUsername, szPassword, {
        success: function (xmlDoc) {
            //console.info(szDeviceIdentify + " 登录成功！");
            ...
            setTimeout(function () {
				...
				// 预览1:主码流，2:子码流
				clickStartRealPlay(streamType, szDeviceIdentify, "", channels);
            }, 100);
        },
...
// 开始预览
function clickStartRealPlay(iStreamType, szDeviceIdentify, iRtspPort, iChannelID) {
    ...
    var startRealPlay = function (WebVideoCtrl) {
